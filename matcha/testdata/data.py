...
def clean():
	...
	if os.path.exists("../site.db"):
  		os.remove("../site.db")
	if os.path.exists("../site.db-journal"):
		os.remove("../site.db-journal")
...
def get_picture(uid):
	...
	picture_path = os.path.join('../static/photos', picture_fn)
	...
	if download == 1:
		...
		dst = picture_path
		src = 'photos/' + str(randrange(19) + 1) + '.jpg'
